...
public final class JpaEntityFixtures {
    ...
    public static SegmentJpaEntity segment(long id, String origin, String destination, Instant departureAt) {
        SegmentJpaEntity entity =
                new SegmentJpaEntity(null, origin, destination, TestFixtures.AIRLINE, departureAt);
    ...
    public static PassengerJpaEntity passenger(long id, String firstName, String documentNumber) {
        PassengerJpaEntity entity = new PassengerJpaEntity(
                null, firstName, "Pérez", LocalDate.of(1990, 5, 20), documentNumber);
        ReflectionTestUtils.setField(entity, "id", id);
        return entity;
    }

    public static ItineraryJpaEntity itinerary(long id, String price, String currency, List<SegmentJpaEntity> segments) {
    ...
    public static ItineraryJpaEntity directItinerary(long id) {
        return itinerary(id, "1250.50", "USD",
    ...
    public static ReservationJpaEntity pendingReservation(long id, int version) {
        ...
        return reservation(id, version, ReservationStatusJpa.PENDIENTE, directItinerary(50L),
                passengers, TestFixtures.IDEMPOTENCY_KEY.value());
    }
}
