...
public record AuditEntry(
    ...
    public AuditEntry {
        ...
        Objects.requireNonNull(
                resourceVersion, "La versión es obligatoria (usar Optional.empty() si la operación no escribió)");
    ...
    public static AuditEntry allowed(
            AuditAction action, Email actor, String reservationId, long version, Instant occurredAt) {
        return new AuditEntry(action, actor, reservationId, AuditOutcome.ALLOWED, Optional.of(version), occurredAt);
    }
    ...
    public static AuditEntry denied(AuditAction action, Email actor, String reservationId, Instant occurredAt) {
        return new AuditEntry(action, actor, reservationId, AuditOutcome.DENIED, Optional.empty(), occurredAt);
    }
}
